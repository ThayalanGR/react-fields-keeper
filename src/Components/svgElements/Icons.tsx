...
export const Icons = {
    ...
    folder: (props: IconProps) => (
        <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" viewBox="0 0 18 18" fill="currentColor" {...props}>
            <path 
                d="M2.5 1.5C1.675 1.5 1 2.175 1 3v9c0 .825.675 1.5 1.5 1.5h11c.825 0 1.5-.675 1.5-1.5V5c0-.825-.675-1.5-1.5-1.5H6.8l-.65-1.2A1.13 1.13 0 0 0 5.2 2H2.5zM2 3h3.2l.4.75H2V3.5c0-.275.225-.5.5-.5zM2 5h11c.275 0 .5.225.5.5v6c0 .275-.225.5-.5.5H2.5a.5.5 0 0 1-.5-.5V5z">
            </path>
        </svg>
    )
};