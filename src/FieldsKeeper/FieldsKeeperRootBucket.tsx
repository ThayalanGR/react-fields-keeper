...
import { IFieldsKeeperItem, IFieldsKeeperRootBucketProps } from "./FieldsKeeper.types";
...
export const FieldsKeeperRootBucket = (props: IFieldsKeeperRootBucketProps) => {
    ...
    const onFieldItemClick = (fieldItem: IFieldsKeeperItem, remove = false) => () => {
    ...
    // event handlers
    const onDragStartHandler = (fieldItem: IFieldsKeeperItem) => (
        e: React.DragEvent<HTMLDivElement>
    ) => {
        e.dataTransfer.setData("fieldKeeperItem", fieldItem.id);
    };
